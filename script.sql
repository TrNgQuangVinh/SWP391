USE [DiamondShop]
GO
ALTER TABLE [dbo].[Shells] DROP CONSTRAINT [FK_Shells_Material]
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 7/1/2024 10:01:16 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Products]') AND type in (N'U'))
DROP TABLE [dbo].[Products]
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 7/1/2024 10:01:16 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Orders]') AND type in (N'U'))
DROP TABLE [dbo].[Orders]
GO
/****** Object:  Table [dbo].[Order Vouchers]    Script Date: 7/1/2024 10:01:16 PM ******/
...
GO
/****** Object:  Table [dbo].[Order Detail]    Script Date: 7/1/2024 10:01:16 PM ******/
...
GO
/****** Object:  Table [dbo].[Carts]    Script Date: 7/1/2024 10:01:16 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Carts]') AND type in (N'U'))
DROP TABLE [dbo].[Carts]
GO
/****** Object:  Table [dbo].[Accounts]    Script Date: 7/1/2024 10:01:16 PM ******/
...
GO
/****** Object:  Database [DiamondShop]    Script Date: 7/1/2024 10:01:16 PM ******/
...
CREATE TABLE [dbo].[Products](
 ...
 CONSTRAINT [PK__Products__B40CC6ED2435B496] PRIMARY KEY CLUSTERED 
(
	[ProductID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
